...
On Windows Julia and Juliaup can be installed directly from the Windows store [here](https://apps.microsoft.com/store/detail/julia/9NJNWW8PVKMN). One can also install exactly the same version by executing
