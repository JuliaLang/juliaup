...
- Run `powershell -nop -c iex (New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/Julialang/juliaup/master/juliaup-init.sh.cmd')` 
    or [download and run it](https://raw.githubusercontent.com/Julialang/juliaup/master/juliaup-init.sh.cmd) and follow the prompt.
...
### Linux Users
- Run `curl https://raw.githubusercontent.com/Julialang/juliaup/master/juliaup-init.sh.cmd | sh` or [download and run it](https://raw.githubusercontent.com/Julialang/juliaup/master/juliaup-init.sh.cmd) to install juliaup.
