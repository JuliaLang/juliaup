...
function main()
    ...
    db_x64["AvailableVersions"]["1.7.0.0-beta2~x64"] = Dict("Url"=>"https://julialang-s3.julialang.org/bin/winnt/x64/1.7/julia-1.7.0-beta2-win64.tar.gz")
    db_x64["AvailableVersions"]["1.7.0.0-beta2~x86"] = Dict("Url"=>"https://julialang-s3.julialang.org/bin/winnt/x86/1.7/julia-1.7.0-beta2-win32.tar.gz")
    db_x86["AvailableVersions"]["1.7.0.0-beta2~x86"] = Dict("Url"=>"https://julialang-s3.julialang.org/bin/winnt/x86/1.7/julia-1.7.0-beta2-win32.tar.gz")
    ...
    db_x64["AvailableChannels"]["beta~x64"] = Dict("Version" => "1.7.0.0-beta2~x64")
    db_x64["AvailableChannels"]["beta~x86"] = Dict("Version" => "1.7.0.0-beta2~x86")
    db_x86["AvailableChannels"]["beta~x86"] = Dict("Version" => "1.7.0.0-beta2~x86")
    db_x64["AvailableChannels"]["beta"] = Dict("Version" => "1.7.0.0-beta2~x64")
    db_x86["AvailableChannels"]["beta"] = Dict("Version" => "1.7.0.0-beta2~x86")
