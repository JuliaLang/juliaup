...
fn produce_version_db() -> Result<JuliaupVersionDB> {
    ...
    let beta_version = Version::parse("1.8.0")?;
    let rc_version = Version::parse("1.8.0")?;
    ...
    original_available_versions.push(Version::parse("1.6.7")?);
    ...
    original_available_versions.push(Version::parse("1.8.0")?);
