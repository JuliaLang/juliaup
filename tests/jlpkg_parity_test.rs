...
fn test_help_subcommands() {
    ...
    let subcommands = vec![
        "add", "build", "compat", "develop", "free", "gc", "generate",
        "instantiate", "pin", "precompile", "remove", "registry", "resolve",
        "status", "test", "update", "preview", "why", "clean"
    ];
...
fn test_complex_package_specs() {
    ...
    let specs = vec![
        ...
        vec!["add", "https://github.com/JuliaLang/Example.jl#master", "--help"],
    ];
