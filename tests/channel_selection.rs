...
fn channel_selection() {
    ...
    Command::cargo_bin("julia")
        ...
        .success()
        .stdout("1.8.2")
        .stderr(contains("Info: Installing Julia 1.8.2 automatically per juliaup settings..."));
    ...
    Command::cargo_bin("julia")
        ...
        .success()
        .stdout("SUCCESS")
        .stderr(contains("Info: Installing Julia nightly automatically per juliaup settings..."));
...
fn auto_install_valid_channel() {
    ...
    Command::cargo_bin("julia")
        ...
        .success()
        .stdout("1.10.10")
        .stderr(contains("Info: Installing Julia 1.10.10 automatically per juliaup settings..."));
}
