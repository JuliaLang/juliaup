...
$x64Versions = Get-Content versiondb\versiondb-x86_64-w64-mingw32.json | ConvertFrom-Json
...
$x86Versions = Get-Content versiondb\versiondb-i686-w64-mingw32.json | ConvertFrom-Json
